...
class Domande(models.Model):
    ...
    pr_prot_isee_inps = models.CharField(max_length=9, blank=True, null=True)
    ...
    pr_imp_buoniscuola = models.DecimalField(max_digits=10, decimal_places=2, blank=False, null=False)
    pr_imp_buoniinps = models.DecimalField(max_digits=10, decimal_places=2, blank=False, null=False)
