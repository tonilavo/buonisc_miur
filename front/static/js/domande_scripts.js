...
$(document).ready(function(){
    ...
    document.getElementById('id_pr_isee').readOnly = true;     
    document.getElementById('id_pr_codfiscale').readOnly = true; 
    ...
    function carica_listaasili(tipo, asilo_selezionato) {
        ...
        if ((location.hostname=='django-01.comune.grosseto.it') || (location.hostname=='django-04.comune.grosseto.it'))
            ...
            var Url_api= "http://www.comune.grosseto.it/buoniscuola/api/asili_json/";
